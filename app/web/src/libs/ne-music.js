...
(function(ng) {
    ...
    .run(['$templateCache', '$sce', 'styleService', function($templateCache, $sce, styleService) {
        ...
        <div class="item" ng-show="iframeReady">\
            <iframe sandbox="allow-scripts allow-same-origin" ng-src="{{safeSongLink}}" class="item-frame"></iframe> \
    ...
    ');
        ...
        .run(function() {
            ...
            JQLite.prototype.idx = function(ele) {
            ...
            return {
                ...
                link: function(scope, element, attr) {
                    ...
                    scope.setTheSong = function() {
                        ...
                        scope.$emit('iframeLoading');
                        scope.setSong({ index: element.idx() });
                    };
                    scope.deleteTheSong = function() {
                        scope.$broadcast('$destroy');
                        scope.deleteSong({ index: element.idx() });
                    };
                }
            };
        }])
